...
- Declare uma constante "myFavoriteTom" que recebe nome, espaço, e sobrenome do Tom 
  que você mais gosta;
...
const second = 'Cruise'
const myFavoriteTom = tom + ' ' + second //espaço é a string vazia. 
...
- Armazene, em uma constante "mdn", a junção das letras iniciais das 3 
  palavras que a constante "mozilla" armazena;
...
faça com que a obtenção da última letra funcione para qualquer 
palavra que a "randomWord" receber;
...
- Não digite a nova string manualmente.
*/
const winterMessage = 'o inverno esta chegando'
...
- Exiba, no console, o index da última ocorrência do caractere "n" da 
"winterMessage".
*/
...
- Utilize o operador addition assignment para atualizar o valor da let 
  "episodes" para 10;
...
- Abaixo deste comentário, armazene a string 'O nº de episódios é: 
  NUMERO_DE_EPISÓDIOS' em uma constante "allEpisodes";
- Insira a let "episodes" no lugar de "NUMERO_DE_EPISÓDIOS";
- Exiba a "allEpisodes" no console.
*/
const allEpisodes = 'O nº de episódios é: ' + episodes //resultado de string + numero será = string
...
/*
21 - Comente o console.log acima 
(e a const bookMessage caso não tenha descoberto a resolução), e,
...
OBS.: string ES5 => é o uso do sinal de '+' para concatenar/juntar as strings pegando através do palavra[0], colchetes.
*/
