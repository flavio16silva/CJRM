/*
01 - Neste diretório (bateria-de-exercicios-01), há um index.html 
vazio.
...
/*
03 - Para certificar-se que este arquivo realmente está linkado, 
exiba a frase "JS is Awesome!" em um alert no browser.

Como mencionei durante a aula: não se preocupe em entender 100% 
o que os comandos "alert" e "console" fazem. 
Nós falaremos sobre eles mais à frente =)
...
/*
04 - Comente o alert que você escreveu acima,
 utilizando o comentário de uma linha.
*/

/*
05 - Declare uma const "myBirthYear", que recebe o ano do seu 
nascimento, com 4 dígitos. Ex.: 1930.
*/
 const myBirthYear = 1981


/*
06 - Declare uma const "currentYear", que recebe o ano atual, 
com 4 dígitos.
*/
...
/*
07 - Exiba as const "myBirthYear" e "currentYear", lado a lado, 
...
- Declare uma const "myAge", que recebe o ano atual subtraído 
pelo ano do seu nascimento. Mas sem digitar os números manualmente.

Você pode utilizar o sinal de menos (-) entre os dois valores 
...
/*
09 - Antes do console.log abaixo, declare uma const "ten", que 
recebe o número 10 e:
...
Não se assuste com as crases e os cifrões. Conversaremos mais sobre 
operações matemáticas e strings (textos) em breve =)
*/
