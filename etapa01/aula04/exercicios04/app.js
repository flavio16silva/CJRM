...
const my3FavoriteTVShows = ['Heroes', 'Flash', 'Superman']
...
//console.log(`A string que a "typeSentence" armazena tem mais de ${numCaracter} caracteres? ${String(typeSentence.length > numCaracter).replace('t', 'T')}.`)
