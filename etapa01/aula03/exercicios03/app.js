...
- Coxinha
- null => atribuir intensionalmente uma falta de valor ao item. Não adicionar como string, mas como valor.
- Brigadeiro
...
//Expressão => é qualquer pedaço de código que resulta em valor. 
//console.log(dogNames)
  dogNames.pop()  //remoção do ultimo item do array
...
//=> Pegando um caracter podemos usar notação de array[index][letra]. Pegando mais caracter usamos o slice()
...
oddNumbers[1] += 4               //=> receber todo o valor que ele já tem, usar =>  +=
console.log(oddNumbers[1] ** 3)  //125