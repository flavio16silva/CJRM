...
let upperCaseCities = [] //=> armazenar as cidades aqui

for (let i = 0; i < cities.length; i++){
  upperCaseCities.push(cities[i].toUpperCase()) //=> o uso do ponto após o upperCaseCities, sinaliza o recebimento de valor. 
}
...
for (let i = 0; i < names.length; i++) {
  ...
  //obs.: Não tem problema concatenar uma string ES5 '' com uma template string `` pois juntas retornam uma String.
