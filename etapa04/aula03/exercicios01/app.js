...
//ceil => teto, arrendondar para o máximo
...
const indexNumber = Math.random() //numero decimal aleatorio entre 0 e 1
console.log(Math.round(indexNumber * 10))
